...
Chú thích: Biểu đồ này có tên gọi là "training curve", nó trình bày diễn tiến huấn luyện một mô hình Machine learning. Theo kết quả hiện thời, mô hình chính thức đã trải qua 300 lượt huấn luyện, và giá trị hàm mất mát (loss function được giảm dần từ 0.7 xuống còn 0.5. Ở đây thuật toán xgboost dùng hàm binary logloss - đo lường độ lỗi của kết quả dự báo so với giá trị thực tế (0,1) ở thang đo logarit.
